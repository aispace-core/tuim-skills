...
Normal PPT exists because AI-generated decks often fail before visual rendering starts: raw material is passed directly into a slide generator, so the model's reasoning noise, explanatory habits, summary voice, and overstuffed structure leak into the final slides.
...
- **normalr / normalr-zh**: remove AI writing traces, filler phrases, fake significance, and mechanical rhythm.
...
A Normal PPT outline is valid only if it answers:
